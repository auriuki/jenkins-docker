...
# Read before
[ALWAYS START FROM OFFICIAL DOCUMENTATION!!! - click it](https://jenkins.io/doc/book/installing/)
...
- dockers ([Docker on Windows](https://jenkins.io/projects/blueocean/roadmap/) -> [JENKINS-36776](https://issues.jenkins-ci.org/browse/JENKINS-36776)) are not supported in Jenkins on Windows (there are many other tickets)
...
- `-d` - run as daemon, so you can detach console window<br>
...
- `jenkinsci/blueocean` - name of docker used to create Jenkins - released every time when new blue ocean is released <br>
